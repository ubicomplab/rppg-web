...
describe('createTypeOpAttr()', function () {
    ...
    it('Creates a valid type attribute', function () {
        var attr = nodejs_kernel_backend_1.createTensorsTypeOpAttr('foo', 'float32');
    ...
    it('handles unknown dtypes', function () {
        expect(function () { return nodejs_kernel_backend_1.createTensorsTypeOpAttr('foo', null); }).toThrowError();
    });
});
